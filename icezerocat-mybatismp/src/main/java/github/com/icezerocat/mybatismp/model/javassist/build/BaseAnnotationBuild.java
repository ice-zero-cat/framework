package github.com.icezerocat.mybatismp.model.javassist.build;
...
public abstract class BaseAnnotationBuild {
     ...
     * @return 构建类
     */
    public BaseAnnotationBuild addMemberValue(String member, @Nonnull String value) {
        MemberValue memberValue = new StringMemberValue(value, this.constPool);
        this.annotation.addMemberValue(member, memberValue);
        return this;
    }

    public BaseAnnotationBuild addMemberValueArr(String member, @Nonnull String[] value) {
    ...
    public BaseAnnotationBuild addMemberValue(String member, @Nonnull Integer... value) {
    ...
    public BaseAnnotationBuild addMemberValueArr(String member, @Nonnull Integer[] value) {
    ...
    public BaseAnnotationBuild addMemberValue(String member, @Nonnull Boolean value) {
        MemberValue memberValue = new BooleanMemberValue(value, this.constPool);
        this.annotation.addMemberValue(member, memberValue);
        return this;
    }

    public BaseAnnotationBuild addMemberValueArr(String member, @Nonnull Boolean[] value) {
    ...
    public BaseAnnotationBuild addMemberValue(String member, @Nonnull short... value) {
    ...
    public BaseAnnotationBuild addMemberValueArr(String member, @Nonnull short[] value) {
    ...
    public BaseAnnotationBuild addMemberValue(String member, @Nonnull Annotation... value) {
    ...
    public BaseAnnotationBuild addMemberValueArr(String member, @Nonnull Annotation[] value) {
    ...
    public BaseAnnotationBuild addMemberByteValue(String member, @Nonnull Byte... value) {
    ...
    public BaseAnnotationBuild addMemberByteValueArr(String member, @Nonnull Byte[] value) {
    ...
    public BaseAnnotationBuild addMemberValue(String member, @Nonnull char... value) {
    ...
    public BaseAnnotationBuild addMemberValueArr(String member, @Nonnull char[] value) {
    ...
    public BaseAnnotationBuild addMemberValue(String member, @Nonnull Double... value) {
    ...
    public BaseAnnotationBuild addMemberValueArr(String member, @Nonnull Double[] value) {
    ...
    public BaseAnnotationBuild addMemberValueByClassName(String member, @Nonnull String... value) {
    ...
    public BaseAnnotationBuild addMemberValueByClassNameArr(String member, @Nonnull String[] value) {
    ...
    public BaseAnnotationBuild addMemberValue(String member, @Nonnull MemberValue memberValue) {
        this.annotation.addMemberValue(member, memberValue);
        return this;
    }
}
